...
//                 </div>
//                 <p>
//                   Sed vel mattis dolor. Vestibulum gravida, dolor vel dapibus
//                   bibendum, velit enim finibus mauris, in volutpat arcu magna ac
//                   metus. Sed condimentum, erat vel sodales pharetra, ligula
//                   massa maximus dolor
//                 </p>
//               </div>
//               <div className="image">
...
const TestimonialSlider = ({ testi }) => {
  ...
  return (
    <div className="m-testimonials">
      <Swiper {...testimonialsSlider} className="swiper-container js-testimonials">
        <div className="swiper-wrapper">
            ...
            <SwiperSlide key={index} className="swiper-slide">
              <div className="testimonials-item">
                <div className="text">
                  <div className="icon">
                  {testimonials.image && (
                      <img src={testimonials.image?.url} alt={testimonials.name} />
                    )}
                  </div>
                ...
                <div className="info">
                  ...
                  <div className="author">{testimonials.position}</div>
                </div>
              </div>
            </SwiperSlide>
          ))}
